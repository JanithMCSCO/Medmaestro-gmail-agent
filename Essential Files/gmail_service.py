        ...
        try:
            ...
            if not creds or not creds.valid:
                if creds and creds.expired and creds.refresh_token:
                    ...
                    logger.error("No valid Gmail token found. Please run authentication first.")
                    logger.error("Run: python headless_auth.py")
                    raise Exception("Gmail authentication required. Please run headless_auth.py first.")
